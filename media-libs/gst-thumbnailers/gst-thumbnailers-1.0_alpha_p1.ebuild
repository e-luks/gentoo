...
SRC_URI="
	${CARGO_CRATE_URIS}
	SRC_URI=https://gitlab.gnome.org/sophie-h/gst-thumbnailers/-/archive/1.0.alpha.1/gst-thumbnailers-1.0.alpha.1.tar.gz?ref_type=tags -> ${P}.tar.gz
"
...
DEPEND="${RDEPEND}
	...
	>=media-libs/gst-plugins-base-1.26.0
...
src_unpack(){
	mkdir -p "${S}"
	tar -xvf "${DISTDIR}/${P}.tar.gz" -C "${S}" --strip-components=1
}
